...
export default function Usuarios() {
  ...
  function handleDelete(user: IUser) {
    ...
    openToast(
      `Do you really want to delete ${selectedUser?.name}?`,
      () => handleDeleteUser(),
      () => {
        return null
      },
  ...
  return (
    <div className="flex-1 items-center justify-center text-black">
      <Toast
        message={`Do you really want to delete ${selectedUser?.name}?`}
        onCancel={() => { }}
      ...
      <div className="flex justify-between items-center pb-2">
        ...
        <div>
          <LinkButton
            className="bg-gradient-to-r from-blue-600 to-blue-400 text-white px-4 rounded-full"
